...
const { ChainId } = require("@mantleswap/core-sdk");
...
(async () => {
  try {
    ...
    for (const key of Object.keys(ChainId)) {
      ...
      // Grab file file names of the mantleswap/icons repo at the token path
      ...
      for (const token of tokens) {
        ...
        if (!token.logoURI.includes("mantleswap/icons")) {
          // TODO: Automate this part...
          const logoURI = `https://raw.githubusercontent.com/mantleswap/icons/master/token/${icon}.png`;
